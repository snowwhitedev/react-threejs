...
import grass_pattern from '../../../assets/textures/terrain/grasslight-big.jpg';
import circuit_pattern from '../../../assets/textures/patterns/circuit_pattern.png'
...
const AnimationCloth = () => {
  useEffect(() => {
    ...
    function init() {
      const rootContainer = document.getElementById('animation-cloth');
      ...
      // camera
      camera = new THREE.PerspectiveCamera(30, CONTAINER_WIDTH / window.innerHeight, 1, 10000);
      ...
      const clothTexture = loader.load(circuit_pattern);
      ...
      // ground
      const groundTexture = loader.load(grass_pattern);
